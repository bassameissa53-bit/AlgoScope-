...
const socialLinks = [
  ...
  },
  {
    ...
    color: "bg-neutral-600/10 text-neutral-300 hover:bg-neutral-600/20",
  },
];
      ...
      <div className="px-4 py-6">
        <div className="flex items-center justify-between mb-8">
          <div className="text-center flex-1">
            <h1 className="text-xl font-bold mb-2">{t("contact.title")}</h1>
        ...
        {/* Social Links */}
        <h2 className="text-sm font-semibold mb-4">{t("contact.followUs")}</h2>
        <div className="grid grid-cols-2 gap-4 mb-8">
          {socialLinks.map((social) => (
            <a
              ...
              className="block"
            >
              <Card className={`card-elevated transition-all ${social.color}`}>
        ...
        {/* Email Contact */}
        <h2 className="text-sm font-semibold mb-4">{t("contact.emailUs")}</h2>
